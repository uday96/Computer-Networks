...
----------------------------------------------------------
Execute Command : ./ShellScript.sh
...
SlottedAloha.java : Executes the protocol and stores output in result.txt

UtilisationPlot.java : Reads data from result.txt and Plots a Graph
	Uses JFreeChart for plotting. jcommon-1.0.23.jar and jfreechart-1.0.19.jar needed for execution.

Summary of Command Line Options: The command line options provided are listed below:
